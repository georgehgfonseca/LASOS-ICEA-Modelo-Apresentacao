...
\title{Template para Apresentações do Lasos}
\author{and }
\author[shortname]{George H.G. Fonseca  \inst{1} \and Thiago A.O. Silva \inst{2}}
\institute[shortinst]
{
\inst{1} LASOS - DECSI - ICEA
%affiliation for author1
\and %
\inst{2} LASOS - DEENP - ICEA
